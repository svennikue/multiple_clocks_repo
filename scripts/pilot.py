...
for sub in subjects:
    ...
    # an EV has to be a 3-column .txt file, onset(in seconds), duration, magnitude
        ...
        df_all = pd.read_csv(data_dir+file_all[f])
        ...
        EV_folder = f'/Users/xpsy1114/Documents/projects/multiple_clocks/output/{file}_EVs_combined/'
        if not os.path.exists(EV_folder):
            os.mkdir(EV_folder)
        ...
        filtered_df = df[df['Column'].str.contains('A')]
