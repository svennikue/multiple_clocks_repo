...
# =============================================================================
# These loaders were previously defined inline here. They now live in
# mc.analyse.anatomy_sources so that the LFP / ripple pipeline resolves
# electrode anatomy through the SAME implementation: if these rules change,
...
print("=========================================================\n")
# Atlas objects and the ROI rule ladder -> mc/analyse/anatomy_atlas.py, so the
# LFP pipeline assigns ROIs with the identical rules. get_atlases() runs the
# same nilearn fetches and MaxProbAtlas instantiations that used to sit inline
# here and populates that module's globals, which assign_atlas_roi reads. The
# four atlas objects stay script globals because later steps use them.
from mc.analyse.anatomy_atlas import (                # noqa: E402
    MaxProbAtlas,
    load_brainnetome_labels,
    assign_atlas_roi,
    get_atlases,
)

path_to_brainnetome = "/Users/xpsy1114/Documents/toolboxes/Brainnatome"
ho_cort, ho_sub, juelich, brainnetome = get_atlases(path_to_brainnetome)
