...
%         disp(['Created directory: ', subject_folder]);
%     end
% 
...
%     if sub > 51
%         end_time = subj.trial_vars(end).DONOTUSE_button_pressed_timestamp(end);
%     else
...
%         csvwrite(sprintf("%s/locations_per_50ms_grid%d_sub%02d.csv", subject_folder, grid_num(last_repeat), sub), locations_per_50ms_curr_grid);
% 
