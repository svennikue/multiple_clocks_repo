...
elif regression_version in ['03-4', '04-4', '03-4-e', '03-4-l', '03-4-rep']: # only including tasks without double reward locs: A,C,D  and only rewards
...
if regression_version in ['03-4-rep']:
    reps = ['1', '2', '3', '4', '5']
    for rep in reps:
        regression_version = f"{regression_version}{rep}"
        for sub in subjects:
