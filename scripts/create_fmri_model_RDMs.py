...
for sub in subjects:
    for task_half in task_halves:
        ...
        #
        #
        # try to do the same shit but with fucking dicitonaries
        # go through all rows and extract the respective info per timepoint.
        ...
        for config in configs:
            ...
            for no_run in range(len(step_number)):
                ...
                # THIS IS ALSO IMPORTANT FOR THE OTHER REGRESSION???
                # THINK ABOUT THIS
