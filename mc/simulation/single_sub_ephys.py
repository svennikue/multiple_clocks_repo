...
def reg_across_tasks_playground(task_configs, locations_all, neurons, timings_all, mouse_recday):
    # import pdb; pdb.set_trace()
    coefficient = list()
...
def reg_across_tasks(task_configs, locations_all, neurons, timings_all, mouse_recday, plotting = False):
    # import pdb; pdb.set_trace()
    # this is now all  based on creating an average across runs first.
    z_score_all = 2 # 2 means only z-score the data
    ignore_double_tasks = 1
