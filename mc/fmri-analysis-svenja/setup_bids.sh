...
cp $rawDir/images_04*.nii $funcDir/
cp $funcDir/images_04*.nii $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
gzip $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
#rm $funcDir/sub-${subjectTag}_1_vol_1_bold.nii

# func 1 
cp $rawDir/images_05*.nii $funcDir/
cp $funcDir/images_05*.nii $funcDir/sub-${subjectTag}_1_bold.nii
...
cp $funcDir/images_07*.nii $funcDir/sub-${subjectTag}_1_vol_2_bold.nii
gzip $funcDir/sub-${subjectTag}_1_vol_2_bold.nii
#rm $funcDir/sub-${subjectTag}_1_vol_2_bold.nii

# func 2 
cp $rawDir/images_08*.nii $funcDir/
cp $funcDir/images_08*.nii $funcDir/sub-${subjectTag}_2_bold.nii
...
cp $funcDir/images_09*.nii $funcDir/sub-${subjectTag}_1_bold_wb.nii
gzip $funcDir/sub-${subjectTag}_1_bold_wb.nii
#rm $funcDir/sub-${subjectTag}_1_bold_wb.nii

cp $rawDir/images_010*.nii $funcDir/
cp $funcDir/images_010*.nii $funcDir/sub-${subjectTag}_2_bold_wb.nii
