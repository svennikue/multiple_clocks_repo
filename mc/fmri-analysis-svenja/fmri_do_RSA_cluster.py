...
for sub in subjects:
    ...
    for task_half in task_halves:
        ...
        mask_file = f"/Users/xpsy1114/Documents/projects/multiple_clocks/data/derivatives/{sub}/func/mask_pt0{task_half}_mask.nii.gz"
        if os.path.isfile(mask_file) == False:
            mask_file = f"{data_dir}/anat/{sub}_T1w_biascorr_noCSF_brain_mask_examplefunc_pt0{task_half}.nii.gz"
        ...
        # write a save function for this file at some point so I don't need to rerun
        # and also for centers, and neighbors
