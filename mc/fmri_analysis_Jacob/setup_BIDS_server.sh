...
cp $funcDir/images_07*.nii $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
gzip $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
rm $funcDir/sub-${subjectTag}_1_vol_1_bold.nii

# func 1 
cp $rawDir/images_08*.nii $funcDir/
cp $funcDir/images_08*.nii $funcDir/sub-${subjectTag}_1_bold.nii
