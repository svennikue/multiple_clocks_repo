...
cat $homeDir/Analysis/RSAGenerateRDMsWrapper.m | sed "s:inputFolder:\'$inputDir\':g" | sed "s:subjectTag:\'${subjectTag}':g" | sed "s:outputFolder:\'$rdmDir\':g" > $rsaDir/sub-${subjectTag}_RDMs_${version}.m
