...
expName = '3x3_practice_v3'  # from the Builder filename that created this script
expInfo = {'participant': '', 'session': '001'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='C:\\Users\\behrenslab-fmrib\\Documents\\Psychopy\\musicbox\\experiment\\3x3_practice_v3.py',
    savePickle=True, saveWideText=True,
...
reward_A_feedback = visual.TextStim(win=win, name='reward_A_feedback',
    ...
    font='Open Sans',
    pos=(0.5, 0), height=0.07, wrapWidth=0.4, ori=0.0, 
...
thisExp.addData('ship_intro_0.started', ship_intro_0.tStartRefresh)
thisExp.addData('ship_intro_0.stopped', ship_intro_0.tStopRefresh)
thisExp.addData('text.started', text.tStartRefresh)
thisExp.addData('text.stopped', text.tStopRefresh)
thisExp.addData('ship_box_intro_0.started', ship_box_intro_0.tStartRefresh)
thisExp.addData('ship_box_intro_0.stopped', ship_box_intro_0.tStopRefresh)
thisExp.addData('text_intro_0.started', text_intro_0.tStartRefresh)
thisExp.addData('text_intro_0.stopped', text_intro_0.tStopRefresh)
# check responses
...
thisExp.addData('next_intro_0.started', next_intro_0.tStartRefresh)
thisExp.addData('next_intro_0.stopped', next_intro_0.tStopRefresh)
thisExp.nextEntry()
...
for thisComponent in intro_1Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('ship_box_intro_1.started', ship_box_intro_1.tStartRefresh)
thisExp.addData('ship_box_intro_1.stopped', ship_box_intro_1.tStopRefresh)
thisExp.addData('text_intro_1.started', text_intro_1.tStartRefresh)
thisExp.addData('text_intro_1.stopped', text_intro_1.tStopRefresh)
# check responses
...
thisExp.addData('next_intro_1.started', next_intro_1.tStartRefresh)
thisExp.addData('next_intro_1.stopped', next_intro_1.tStopRefresh)
thisExp.nextEntry()
...
for thisComponent in intro_2Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('treasure_box_intro_2.started', treasure_box_intro_2.tStartRefresh)
thisExp.addData('treasure_box_intro_2.stopped', treasure_box_intro_2.tStopRefresh)
thisExp.addData('text_intro_2.started', text_intro_2.tStartRefresh)
thisExp.addData('text_intro_2.stopped', text_intro_2.tStopRefresh)
# check responses
...
thisExp.addData('next_intro_2.started', next_intro_2.tStartRefresh)
thisExp.addData('next_intro_2.stopped', next_intro_2.tStopRefresh)
thisExp.nextEntry()
thisExp.addData('navigation_img.started', navigation_img.tStartRefresh)
thisExp.addData('navigation_img.stopped', navigation_img.tStopRefresh)
...
for thisComponent in up_down_practiceComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('parrot_updown_empty.started', parrot_updown_empty.tStartRefresh)
thisExp.addData('parrot_updown_empty.stopped', parrot_updown_empty.tStopRefresh)
thisExp.addData('help_txt_updown.started', help_txt_updown.tStartRefresh)
thisExp.addData('help_txt_updown.stopped', help_txt_updown.tStopRefresh)
thisExp.addData('updown_pract.started', updown_pract.tStartRefresh)
thisExp.addData('updown_pract.stopped', updown_pract.tStopRefresh)
thisExp.addData('feedback_updown_txt.started', feedback_updown_txt.tStartRefresh)
thisExp.addData('feedback_updown_txt.stopped', feedback_updown_txt.tStopRefresh)
# check responses
...
thisExp.addData('nav_vert_key.started', nav_vert_key.tStartRefresh)
thisExp.addData('nav_vert_key.stopped', nav_vert_key.tStopRefresh)
thisExp.nextEntry()
thisExp.addData('foot_vert.started', foot_vert.tStartRefresh)
thisExp.addData('foot_vert.stopped', foot_vert.tStopRefresh)
...
for thisComponent in left_right_practiceComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('left_right_pract.started', left_right_pract.tStartRefresh)
thisExp.addData('left_right_pract.stopped', left_right_pract.tStopRefresh)
thisExp.addData('foot_leftright.started', foot_leftright.tStartRefresh)
thisExp.addData('foot_leftright.stopped', foot_leftright.tStopRefresh)
thisExp.addData('intro_leftright.started', intro_leftright.tStartRefresh)
thisExp.addData('intro_leftright.stopped', intro_leftright.tStopRefresh)
thisExp.addData('feedback_leftright.started', feedback_leftright.tStartRefresh)
thisExp.addData('feedback_leftright.stopped', feedback_leftright.tStopRefresh)
# check responses
...
thisExp.addData('nav_horz_key.started', nav_horz_key.tStartRefresh)
thisExp.addData('nav_horz_key.stopped', nav_horz_key.tStopRefresh)
thisExp.nextEntry()
...
for thisComponent in summary_introComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('summary_parrot.started', summary_parrot.tStartRefresh)
thisExp.addData('summary_parrot.stopped', summary_parrot.tStopRefresh)
# check responses
...
thisExp.addData('next_summary_key.started', next_summary_key.tStartRefresh)
thisExp.addData('next_summary_key.stopped', next_summary_key.tStopRefresh)
thisExp.nextEntry()
...
for thisTrial in trials:
    ...
    for thisRep_run in rep_runs:
        ...
        _break_key_allKeys = []
        # keep track of which components have finished
        taskComponents = [sand_box, foot, reward, nav_key_task, break_key, progressbar_background, progress_bar, reward_progress, plus_coin_txt, reward_A_feedback]
        ...
        while continueRoutine:
            ...
            if reward_A_feedback.status == STARTED:  # only update if drawing
        ...
        rep_runs.addData('progressbar_background.started', progressbar_background.tStartRefresh)
        rep_runs.addData('progressbar_background.stopped', progressbar_background.tStopRefresh)
        rep_runs.addData('progress_bar.started', progress_bar.tStartRefresh)
        rep_runs.addData('progress_bar.stopped', progress_bar.tStopRefresh)
        ...
        rep_runs.addData('reward_A_feedback.started', reward_A_feedback.tStartRefresh)
        rep_runs.addData('reward_A_feedback.stopped', reward_A_feedback.tStopRefresh)
