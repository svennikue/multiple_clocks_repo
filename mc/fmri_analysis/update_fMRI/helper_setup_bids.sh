...
# subjectTag="02"
# submit like: bash setup_bids.sh "/home/fs0/xpsy1114/scratch/data/raw/04_scan" 04
rawDir="$1"
subjectTag="$2"
...
cp $funcDir/images_09*.nii $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
gzip $funcDir/sub-${subjectTag}_1_vol_1_bold.nii
#rm $funcDir/sub-${subjectTag}_1_vol_1_bold.nii

# func 1 
cp $rawDir/images_010*.nii $funcDir/
cp $funcDir/images_010*.nii $funcDir/sub-${subjectTag}_1_bold.nii
gzip $funcDir/sub-${subjectTag}_1_bold.nii
#rm $funcDir/sub-${subjectTag}_1_bold.nii

# json as well for slice time info
cp $rawDir/images_010*.json $funcDir/
cp $funcDir/images_010*.json $funcDir/sub-${subjectTag}_1_bold.json


# single volume functional 2
cp $rawDir/images_011*.nii $funcDir/
cp $funcDir/images_011*.nii $funcDir/sub-${subjectTag}_1_vol_2_bold.nii
gzip $funcDir/sub-${subjectTag}_1_vol_2_bold.nii
#rm $funcDir/sub-${subjectTag}_1_vol_2_bold.nii

# func 2 
cp $rawDir/images_012*.nii $funcDir/
cp $funcDir/images_012*.nii $funcDir/sub-${subjectTag}_2_bold.nii
...
# func whole volume
cp $rawDir/images_013*.nii $funcDir/
cp $funcDir/images_013*.nii $funcDir/sub-${subjectTag}_1_bold_wb.nii
gzip $funcDir/sub-${subjectTag}_1_bold_wb.nii
#rm $funcDir/sub-${subjectTag}_1_bold_wb.nii

cp $rawDir/images_014*.nii $funcDir/
cp $funcDir/images_014*.nii $funcDir/sub-${subjectTag}_2_bold_wb.nii
...
cp $fmapDir/images*field*e2.json $fmapDir/sub-${subjectTag}_magnitude2.json
