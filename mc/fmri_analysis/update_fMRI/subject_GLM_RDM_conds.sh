...
# for subjectTag in 15; do
    ...
    for task_half in 1 2 ; do
        ...
        # fsl_sub -q long -T 360 -R 30 feat $funcDir/sub-${subjectTag}_design_glm_${version}_pt${task_half}.fsf
        fsl_sub -q long feat $funcDir/sub-${subjectTag}_design_glm_${version}_pt${task_half}.fsf
    done
done