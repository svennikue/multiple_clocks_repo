...
# Unzip the brain mask because SPM doesn't like .nii.gz
...
cat $homeDir/Analysis/RSASubjectGLMWrapper.m | sed "s:inputFile:\'$homeDir/Analysis/Subjects/${subjectTag}.mat\':g" | sed "s:inputFolder:\'$inputDir\':g" | sed "s/useAllRels/false/g" | sed "s/separateBlocks/true/g" | sed "s/doPlot/false/g" | sed "s:EVFile:\'$inputDir/EVs.mat\':g" | sed "s:subjectTag:\'${subjectTag}':g" | sed "s:outputFolder:\'$outputDir\':g" > $inputDir/sub-${subjectTag}_runGLM_${version}.m
